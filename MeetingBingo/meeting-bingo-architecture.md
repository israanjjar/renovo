...
graph TB
    subgraph Browser["BROWSER ENVIRONMENT"]
        subgraph ReactApp["REACT APPLICATION"]
            ...
            subgraph Speech["Speech Recognition"]
                WebSpeechAPI["Web Speech API"]
                TranscriptProc["Transcript Processing"]
                WordDetection["Word Detection"]
            end

            UI --> ContextState["Context State"]
            GameLogic --> ContextState
            Speech --> ContextState
            ContextState --> LocalStorage["localStorage Persistence"]
        end
...
```mermaid
graph TB
    subgraph Multiplayer["FUTURE: MULTIPLAYER"]
        A["Option A: WebSocket Server"]
        ...
        B["Option B: Peer-to-Peer (WebRTC)"]
        ...
        C["Option C: Firebase Realtime DB"]
