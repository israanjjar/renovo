...
export default function Footer() {
  return (
    <footer className="bg-secondary text-white">
      {/* Gradient top border */}
      <div className="h-1 bg-gradient-to-r from-primary via-accent-warm to-accent" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Impact */}
          <div>
            <h4 className="text-sm font-semibold mb-3">Our Impact</h4>
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={stat.label}>
                  ...
                  <span className="text-sm text-gray-300 ml-2">{stat.label}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg bg-white/10 border border-white/20 px-3 py-2 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:border-accent"
              />
              <button className="rounded-lg bg-accent-warm px-4 py-2 text-sm font-medium text-secondary hover:bg-accent-warm-light transition-colors">
                Subscribe
              </button>
            </div>
          </div>
